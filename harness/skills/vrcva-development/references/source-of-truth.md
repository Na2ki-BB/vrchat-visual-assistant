...
| Result texture, pointer mapping, and controls | `src/VrcVa.Windows/OpenVr/OverlaySurfaceSpec.cs`, `src/VrcVa.Windows/OpenVr/OpenVrInterop.cs`, `src/VrcVa.Windows/OpenVr/ResultPanelTexture.cs`, `src/VrcVa.Windows/OpenVr/SteamVrResultPanel.cs` | `OpenVrOverlayIntersectionTests`, `ResultPanelTextureTests`, `PointerActivationGateTests`, and current-build headset evidence |
| Eye-mirror privacy ordering | `src/VrcVa.Windows/OpenVr/OpenVrOverlayCaptureSequence.cs`, `src/VrcVa.Windows/OpenVr/OpenVrEyeMirrorCapture.cs` | `OpenVrOverlayCaptureSequenceTests.cs` |
